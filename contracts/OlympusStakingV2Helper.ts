...
export interface OlympusStakingV2HelperInterface extends utils.Interface {
  functions: {
...
export interface OlympusStakingV2Helper extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OlympusStakingV2HelperInterface;
