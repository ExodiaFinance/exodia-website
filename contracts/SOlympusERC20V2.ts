...
export interface SOlympusERC20V2Interface extends utils.Interface {
  functions: {
...
export interface SOlympusERC20V2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SOlympusERC20V2Interface;
