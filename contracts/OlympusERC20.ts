...
export interface OlympusERC20Interface extends utils.Interface {
  functions: {
...
export type TWAPEpochChangedEventFilter =
  TypedEventFilter<TWAPEpochChangedEvent>;
...
export type TWAPOracleChangedEventFilter =
  TypedEventFilter<TWAPOracleChangedEvent>;

export type TWAPSourceAddedEvent = TypedEvent<
  [string],
  { newTWAPSource: string }
>;

export type TWAPSourceAddedEventFilter = TypedEventFilter<TWAPSourceAddedEvent>;

export type TWAPSourceRemovedEvent = TypedEvent<
  [string],
  { removedTWAPSource: string }
>;

export type TWAPSourceRemovedEventFilter =
  TypedEventFilter<TWAPSourceRemovedEvent>;
...
export interface OlympusERC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OlympusERC20Interface;
  ...
  filters: {
    ...
    ): TWAPSourceAddedEventFilter;
    TWAPSourceAdded(newTWAPSource?: string | null): TWAPSourceAddedEventFilter;

    "TWAPSourceRemoved(address)"(
      removedTWAPSource?: string | null
    ): TWAPSourceRemovedEventFilter;
    TWAPSourceRemoved(
      removedTWAPSource?: string | null
    ): TWAPSourceRemovedEventFilter;
