...
export class CirculatingSupply__factory {
  static readonly abi = _abi;
  static createInterface(): CirculatingSupplyInterface {
    return new utils.Interface(_abi) as CirculatingSupplyInterface;
  }
  static connect(
    address: string,
